...
function swapPuzzle(e) {
   ...
   if(confirm("You will lose ALL of your work on the puzzle! Continue?")) {
      // store a reference to which button was clicked
      let puzzleID = e.target.id;

      // store a reference to that buttons text value
...
function setupPuzzle() {
   // reference all the data cells in the puzzle table
   ...
   // create object collection (arrays) of just the filled cells and just the empty cells
   ...
   document.getElementById("peek").addEventListener("click", function(){
      ...
      // display incorrext gray cells in red
...
function setBackground(e) {
   ...
   // loop through the puzzleCells arrayand create an event listener for allof them
   for(let i = 0; i < puzzleCells.length; i++){
...
// definition of the endBackground() function which removes all current puzzleCall events
